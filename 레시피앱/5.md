...
- [1. Component State(상태관리)](#1-component-state상태관리)
	- [1.1. 함수형 컴포넌트의 상태관리](#11-함수형-컴포넌트의-상태관리)
		- [1.1.1. useState()](#111-usestate)
			- [1.1.1.1. 카운터를 만들어보자-1](#1111-카운터를-만들어보자-1)
			- [1.1.1.2. 카운터를 만들어보자-2](#1112-카운터를-만들어보자-2)
			- [1.1.1.3. 카운터를 만들어보자-3](#1113-카운터를-만들어보자-3)
			- [1.1.1.4. 카운터를 개선 해보자](#1114-카운터를-개선-해보자)
	- [1.2. 퀴즈퀴즈](#12-퀴즈퀴즈)
- [2. Component LifeCycle(생명주기)](#2-component-lifecycle생명주기)
	...
	- [2.2. 함수형 컴포넌트의 생명주기](#22-함수형-컴포넌트의-생명주기)
		- [2.2.1. useEffect](#221-useeffect)
			- [2.2.1.1. 무한루프 문제상황 만들기](#2211-무한루프-문제상황-만들기)
			- [2.2.1.2. Mount-컴포넌트 렌더링 직전 딱 한번 실행](#2212-mount-컴포넌트-렌더링-직전-딱-한번-실행)
			- [2.2.1.3. Update-컴포넌트 렌더시](#2213-update-컴포넌트-렌더시)
			- [2.2.1.4. UnMount-컴포넌트가 사라질때 실행](#2214-unmount-컴포넌트가-사라질때-실행)
...
2. 버튼에 이벤트리스너를 연결한다. `h1` 사이의 데이터를 변수 로 수정한다.
	...
	이벤트리스너에 바로 setCount 함수호출을 연결할경우 위와 같은 에러 메시지가 확인된다.
