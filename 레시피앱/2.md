...
### 목차 <!-- omit in toc -->
- [1. create-react-app으로 리액트 앱 만들기](#1-create-react-app으로-리액트-앱-만들기)
- [2. README 수정하기](#2-readme-수정하기)
- [3. 리액트 앱 실행하기](#3-리액트-앱-실행하기)
- [4. 리액트 앱 종료하기](#4-리액트-앱-종료하기)
- [5. 비주얼 스튜디오 코드 통합 터미널에서 실행하는 방법](#5-비주얼-스튜디오-코드-통합-터미널에서-실행하는-방법)
- [6. 깃허브에 리액트 앱 업로드하기](#6-깃허브에-리액트-앱-업로드하기)
  - [6.1. 깃허브에 저장소 만들기](#61-깃허브에-저장소-만들기)
  - [6.2. 깃허브 저장소에 리액트 앱 업로드하기](#62-깃허브-저장소에-리액트-앱-업로드하기)
  - [6.3. 깃허브 저장소 확인하기](#63-깃허브-저장소-확인하기)
- [7. 리액트 앱 살펴보고 수정하기](#7-리액트-앱-살펴보고-수정하기)
  - [7.1. 로컬 저장소 초기화하기](#71-로컬-저장소-초기화하기)
  - [7.2. public 폴더 살펴보기](#72-public-폴더-살펴보기)
  - [7.3. index.html 파일 살펴보기](#73-indexhtml-파일-살펴보기)
  - [7.4. App.js 파일 수정하기](#74-appjs-파일-수정하기)
  - [7.5. 리액트 앱 다시 실행하기](#75-리액트-앱-다시-실행하기)
  - [7.6. App.js 파일 수정하기](#76-appjs-파일-수정하기)
  - [7.7. 크롬 개발자 도구로 리액트 앱 살펴보기](#77-크롬-개발자-도구로-리액트-앱-살펴보기)
  - [7.8. Hello!!!!! 가 화면에 어떻게 표시되는지 살펴보기](#78-hello-가-화면에-어떻게-표시되는지-살펴보기)
- [8. 리액트 앱 동작 원리 알아보기](#8-리액트-앱-동작-원리-알아보기)
  - [8.1. index.js 살펴보기](#81-indexjs-살펴보기)
  - [8.2. index.html 수정해 보기](#82-indexhtml-수정해-보기)
  - [8.3. index.js 수정하여 오류 해결하기](#83-indexjs-수정하여-오류-해결하기)
  - [8.4. 파일 원래대로 돌려놓기](#84-파일-원래대로-돌려놓기)
- [9. 완성코드](#9-완성코드)
...
1. 탐색기를 열고 recipeApp 폴더를 만든다.
1. VScode 를 실행후 recipeApp 폴더를 편집창으로 드래그드랍하여 루트폴더로 연다.
...
## 5. 비주얼 스튜디오 코드 통합 터미널에서 실행하는 방법
...
- VSCode의 탐색기를 살펴보면 recipeApp 폴더 안에 우리가 자주 소스를 수정하게 될 public, src 폴더를 볼 수 있다.

### 7.2. public 폴더 살펴보기

- public 폴더에는 favicon.ico 파일이 있는데 이건 브라우저 제목과 함께 표시되는 아이콘이다.

### 7.3. index.html 파일 살펴보기
...
### 7.8. Hello!!!!! 가 화면에 어떻게 표시되는지 살펴보기
...
[!button size="l" variant='primary' icon='mark-github' text='완성소스코드' target='blank'](https://github.com/qwerewqwerew/recipeApp/tree/48cf984d5ec6ad0a21e132173cc16359e2bf46f7)
