...
- [1. 비슷한 컴포넌트 여러 개 만들기](#1-비슷한-컴포넌트-여러-개-만들기)
	...
	- [1.2. 유튜브강의 완료파일 내려받기](#12-유튜브강의-완료파일-내려받기)
	- [1.3. 앞에서 만든 컴포넌트 형태 다시 살펴보기](#13-앞에서-만든-컴포넌트-형태-다시-살펴보기)
	- [1.4. 과일 데이터 만들기1](#14-과일-데이터-만들기1)
	- [1.5. 과일 데이터 만들기2](#15-과일-데이터-만들기2)
...
### 1.2. 유튜브강의 완료파일 내려받기
[!button variant='success' icon='download' text='유튜브강의 완료 파일' target='blank'](./assets/04/chap04_fin.zip)



### 1.3. 앞에서 만든 컴포넌트 형태 다시 살펴보기
