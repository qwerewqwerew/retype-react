...
- [1. 비슷한 컴포넌트 여러 개 만들기](#1-비슷한-컴포넌트-여러-개-만들기)
	- [1.1. 앞에서 만든 컴포넌트 형태 다시 살펴보기](#11-앞에서-만든-컴포넌트-형태-다시-살펴보기)
	- [1.2. 과일 데이터 만들기1](#12-과일-데이터-만들기1)
	- [1.3. 과일 데이터 만들기2](#13-과일-데이터-만들기2)
