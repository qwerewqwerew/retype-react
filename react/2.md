...
> MemberItem.js 컴포넌트를 생성하여 회원목록 컴포넌트를 만들겠습니다.

1. componets 폴더를 생성한후 MemberItem.js를 작성합니다

   ```js # componets/MemberItem.js
...
2. componets 폴더를 생성한후 MemberItem.css를 작성합니다

   ```css # componets/MemberItem.css
   .card {
   	padding: 5%;
   	display: flex;
   	align-items: center;
...
3. App.js 에 MemberItem 컴포넌트를 임포트 합니다.
